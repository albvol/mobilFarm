...
public class ScegliFarmacoPianoAdapter extends ArrayAdapter<JSONObject> {

    private static final String TAG = "ScegliFarmacoPianoAdapter";

    public ScegliFarmacoPianoAdapter(Context context, int textViewResourceId, List objects) {
    ...
    public View getViewOptimize(final int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.scegli_farmaco_piano, null);
